<!-- https://growtopiawiki.com/w/Growmoji_Turkey -->

# Growmoji Turkey

Gobble gobble! Celebrate and give thanks while chatting with friends! Just consume this to add it to your available growmojis!
Properties
...
•  Growmoji Chest  |
The **Growmoji Turkey** is an unsplicable growmoji consumable which was added on November 1, 2018.
##  Function
Upon consuming, the player will now be able to use the (turkey) growmoji.
##  Trivia
