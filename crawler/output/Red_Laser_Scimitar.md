<!-- https://growtopiawiki.com/w/Red_Laser_Scimitar -->
...
When equipped, the **Red Laser Scimitar** grants the _Punch Power + Build Range: Laser Scimitar_ mod, which allows the player to knock back other players further and build one tile further.
##  Gallery
Player using the Red Laser Scimitar
