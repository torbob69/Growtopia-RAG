<!-- https://growtopiawiki.com/w/Growmoji_Ill -->

# Growmoji Ill

Want to add some ill emotions to your chat? Just consume this to add it to your available growmojis!
Properties
...
•  Growmoji Chest  |
**Growmoji Ill** is an unsplicable growmoji consumable which was added on May 1, 2019.
##  Function
Upon consuming, the player will now be able to use the (ill) growmoji.
##  Trivia
